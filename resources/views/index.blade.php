  ...
  <form class="h-adr" action="/confirm" method="post">
    ...
    <table class="contact__form">
      ...
      <tr class="contact__form__row">
        ...
        <td colspan="1" class="error__message">入力内容に誤りがあります。</td><td colspan="1" class="error__message">入力内容に誤りがあります。</td>
      </tr>
      ...
      <tr class="contact__form__row">
        ...
        <td colspan="2" class="contact__form__content"><span class="post__icon">〒</span><input type="text" class="form__box p-postal-code" name="postcode" onKeyUp="AjaxZip3.zip2addr('postcode','','address','address');" value = "{{old('postcode')}}"></td>
      </tr>
